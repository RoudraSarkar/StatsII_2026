...
\lstinputlisting[language=R, firstline=1,lastline=77]{PS01_RS.R} 
\[
D = 0.1347281
\]
...
\vspace{.5cm}
\lstinputlisting[language=R, firstline=79,lastline=137]{PS01_RS.R}
\begin{table}[h!]
	\centering
	\begin{tabular}{lcc}
		\hline
		...
		\hline
	\end{tabular}
	\caption{Comparison of OLS estimates using BFGS and \texttt{lm()}}
\end{table}
